	...
	return (
			...
			<div className=" md:mx-auto text-sm md:text-base px-2 md:px-5 py-8 md:w-[95%] max-w-4xl text-justify bg-[#002233] text-white my-0 md:my-8 md:rounded-xl [&>h2]:text-[#A9C5A0] [&>h1]:text[#0066FF]">
				...
				<p className="mb-4">
					...
					using the Platform, you agree to be bound by these Terms. If
				...
				<p className="mb-4">
					UET Nest Swap is a platform that facilitates direct
					interactions between users for buying, selling, and renting
					items within the UET Taxila University community. We do not
					take any ownership or responsibility for the items listed,
					the transactions conducted, or the interactions between
				...
				<p className="mb-4">
					...
					respectful manner. You agree not to: Post false, misleading,
					or inaccurate information. Engage in fraudulent or deceptive
					activity. Violate the rights of others, including
					intellectual property rights. Harass, abuse, or threaten
					other users. Use the Platform for any illegal or
				...
				<p className="mb-4">
					All transactions are conducted directly between users. UET
					Nest Swap does not hold any funds or handle payments. We are
					not responsible for the outcome of any transaction,
					including disputes or payment issues. Users are encouraged
				...
				<p className="mb-4">
					...
					FOR A PARTICULAR PURPOSE, TITLE, OR NON-INFRINGEMENT. UET
					NEST SWAP DOES NOT WARRANT THAT THE PLATFORM WILL BE
				...
				<p className="mb-4">
					...
					and against all losses, liabilities, damages, expenses, and
					costs (including reasonable attorneys' fees) arising out of
				...
				<p className="mb-4">
					...
					revised Terms on the Platform. Your continued use of the
				...
				<p className="mb-4">
					...
					with the{" "}
					<a
						href="https://pakistancode.gov.pk/english/index.php"
