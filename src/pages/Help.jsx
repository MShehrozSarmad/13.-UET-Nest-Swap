...
const Help = () => {
    return (
        <div className="containerr mx-auto px-4 py-8 w-[95%] max-w-4xl">
            ...
            <div className="mb-8">
                <h2 className="text-2xl font-bold mb-4">Viewing Listings</h2>
            ...
            <div className="mb-8">
                <h2 className="text-2xl font-bold mb-4">Posting Items</h2>
            ...
            <div className="mb-8">
                <h2 className="text-2xl font-bold mb-4">Making Offers</h2>
            ...
            <div className="mb-8">
                <h2 className="text-2xl font-bold mb-4">Deleting Items</h2>
