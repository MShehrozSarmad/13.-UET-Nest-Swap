...
const Help = () => {
    return (
        <>
            <div className="my-0 md:my-8 md:mx-auto text-sm md:text-base px-4 md:px-5 py-8 md:w-[95%] max-w-4xl text-justify bg-[#002233] text-white md:rounded-xl [&>div>h2]:text-[#A9C5A0] [&>h1]:text[#0066FF]">
